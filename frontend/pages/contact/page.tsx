...
function RouteComponent() {
  ...
  React.useEffect(() => {
    ...
    styleEl.textContent = `
      ...
      .animate-contact-appear {
        animation: contact-appear 0.8s ease-out forwards;
      }
      
      .contact-text-delay-1 {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Aura/Glow Effects */}
        <motion.div 
          className="absolute -left-20 top-20 w-72 h-72 bg-blue-400 rounded-full opacity-20 blur-3xl"
          animate={{ 
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.3, 0.2]
          }}
        ...
        ></motion.div>
        <motion.div 
          className="absolute -right-20 bottom-10 w-80 h-80 bg-purple-500 rounded-full opacity-20 blur-3xl"
          animate={{ 
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.3, 0.2]
          }}
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">123 Charity Lane, Mumbai, MH 400001, India</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">support@charityconnect.org</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full min-h-[120px] rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-xs focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] outline-none disabled:cursor-not-allowed disabled:opacity-50"
                />
              </div>
