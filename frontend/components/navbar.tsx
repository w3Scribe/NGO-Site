  ...
  return (
    ...
    >
      <motion.div
        ...
        whileHover="hover"
      >
        <Link to={'/'} className="text-zinc-800 font-semibold text-2xl relative">
          <span className="relative z-10">अस्गाव चॅरिटी</span>
          <motion.span 
        ...
        >
          ...
          >
            <Link to="/signin" className="flex items-center">
              <span>{marathiPhrases.signIn}</span>
              <motion.div
                initial={{ x: 0 }}
                whileHover={{ x: 3 }}
