  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats((prev) => {
        ...
        if (
          newStats.volunteers >= 500 &&
          newStats.ngos >= 30 &&
          newStats.donations >= 5000000 &&
          newStats.beneficiaries >= 10000
        ) {
  ...
  const testimonials = [
    {
      id: 1,
      quote:
        'CharitySmile has transformed how we connect with donors. Our funding has increased by 40% since joining the platform.',
      author: 'Rahul Sharma',
    ...
    },
    {
      id: 2,
      quote:
        "As a volunteer, I've found meaningful opportunities that align with my values. The platform made it easy to contribute to causes I care about.",
      author: 'Priya Patel',
    ...
    },
    {
      id: 3,
      quote:
        "The transparency in donation tracking gave me confidence that my contributions were making a real difference in children's lives.",
      author: 'Amit Verma',
      role: 'Monthly Donor',
      ...
      <section className="bg-slate-50 py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 text-center">
              <div className="text-4xl font-bold text-primary mb-2">
                ₹{(stats.donations / 1000000).toFixed(1)}M
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              CharitySmile is dedicated to bringing happiness to underprivileged
              children, elderly individuals, and those in need. We work to
              provide food, education, medical care, and shelter to those who
              require support.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                ...
                underprivileged children, ensuring they have the tools to
                succeed.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Supporting access to essential healthcare services and medical
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Creating safe living environments and supporting housing
                initiatives for the homeless and displaced.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-gray-600 max-w-2xl">
                These organizations are making remarkable differences in their
                communities. Your support can help them expand their impact.
              </p>
            </div>
            <Button
              asChild
              variant="ghost"
              className="hidden md:flex items-center text-primary hover:text-primary/90 hover:bg-primary/5 transition-all duration-200 rounded-md"
            >
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Button
                    asChild
                    variant="ghost"
                    className="w-full text-primary hover:text-primary/90 hover:bg-primary/5 transition-all duration-200 rounded-md"
                  >
                    <a
                      href={`/NGOs`}
                      className="flex items-center justify-center"
          ...
          <div className="text-center mt-10">
            <Button
              asChild
              variant="ghost"
              className="md:hidden items-center text-primary hover:text-primary/90 hover:bg-primary/5 transition-all duration-200 rounded-md"
            >
              <a href="/NGOs" className="flex items-center justify-center">
                <span>View All NGOs</span>
                <svg
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              Making a difference is easier than you think. Here&apos;s how you
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative">
              ...
              <div className="bg-white rounded-xl shadow-sm p-8 h-full">
                ...
                <p className="text-gray-600 mb-6">
                  Your financial contributions help fund critical programs and
                  provide resources to those in need. Every amount makes a
                  difference.
                </p>
                <Button
                  asChild
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-xl shadow-sm p-8 h-full">
                ...
                <p className="text-gray-600 mb-6">
                  Share your time and skills. Our volunteer opportunities range
                  from teaching to organizing events and administrative support.
                </p>
                <Button
                  asChild
                  variant="ghost"
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-xl shadow-sm p-8 h-full">
                ...
                <p className="text-gray-600 mb-6">
                  Share the mission with your network. Raising awareness is just
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              Join us at these upcoming events to support our cause and connect
              with our community.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full border-primary text-primary hover:bg-primary/10 hover:text-primary/90 transition-all duration-300"
                  >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              Hear from our community of NGOs, volunteers, and donors about
              their experiences.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-10 text-white/90">
            Join our community of volunteers and donors today. Together, we can
            create lasting change and bring smiles to those who need it most.
          </p>
